    ...
    <div id="main-content">
		<form method="post"> 
			...
			{ 
				...
				$result = mysqli_query($con,"SELECT * FROM participant WHERE Event_Name LIKE '%$search_key%'");
			}
			...
			<table id="table_list" class="text-center">
				...
				echo"<td><a class='col-5 m-1 btn btn-info' href=\"view_participant.php?Event_Name=";
				echo $row['Event_Name'];
				echo"&username=";
				echo $row['username'];
				echo"\">View</a></td>";
