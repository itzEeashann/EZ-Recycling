                                        ...
                                        <form method="post">
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" username="password" name='password' placeholder="Enter your Password" value="<?php echo $row["password"] ?>">
                                                </div>          
                                            </div>
                                            <!-- Form Row-->
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" username="firstname" name='firstname' placeholder="Enter your First Name" value="<?php echo $row["firstname"] ?>" >
                                                </div>
                                                <!-- Form Group (last name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="lastname">Last name</label>
                                                    <input class="form-control" username="lastname" name='lastname' placeholder="Enter your Last Name" value="<?php echo $row["lastname"] ?>" >
                                                </div>
                                            </div>
                                                <!-- Form Group (address)-->
                                                <div class="col-6    ">
                                                    <label class="small mb-1 col-6" for="address">Address</label>
                                                    <input class="form-control" username="address" name='address' placeholder="Enter your Address" value="<?php echo $row["address"] ?>">
                                                </div>
                                            <!-- Form Row-->
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" username="contact" name='contact' placeholder="Enter your phone number" value="<?php echo $row["contact"] ?>">
                                                </div>
                                                <!-- Form Group (Email)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="email">Email</label>
                                                    <input class="form-control" username="email" name='email' placeholder="Enter your Email" value="<?php echo $row["email"] ?>">
                                                </div>
                                            </div>
